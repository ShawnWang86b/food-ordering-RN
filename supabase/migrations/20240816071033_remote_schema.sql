...
COMMENT ON TABLE "public"."products" IS 'Product detail';
...
CREATE POLICY "All authenticated users All operations" ON "public"."orders" TO "authenticated" USING (true);

CREATE POLICY "Allow authenticated users Alloperations" ON "public"."order_items" TO "authenticated" USING (true);
